...
namespace TeamPhoenix
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Global.itemList.Add(new EquipItem(0, "무쇠갑옷", "무쇠로 만들어져 튼튼한 갑옷입니다.", new STATUS(0, 5, 0, 0)));
            Global.itemList.Add(new EquipItem(1, "낡은 검", "쉽게 볼 수 있는 낡은 검 입니다.", new STATUS(2, 0, 0, 0)));
