...
namespace TeamPhoenix
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Global.itemList.Add(new EquipItem(2, "마체테", "무언가 자르기 좋아보입니다.", new STATUS(8, 0, 0), 1500));
            Global.itemList.Add(new EquipItem(3, "무쇠신발", "무쇠로 만들어져 튼튼한 신발입니다.", new STATUS(0, 5, 0), 1500));
            Global.itemList.Add(new EquipItem(4, "무쇠투구", "무쇠로 만들어져 튼튼한 투구입니다.", new STATUS(0, 8, 0), 2000));
